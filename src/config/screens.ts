...
import { NDValueScreen } from "@/components/screens/NDValueScreen";
...
export const screens: ScreenDef[] = [
  ...
  { id: "LD1.3", title: "Think Outside the Box — For Everyone", component: WorldChangingScreen, duration: 3, notes: "Frame for the day: thinking outside the box lifts everyone and creates real accommodations for those who need them. Meta: this is a rehearsal, built in a weekend with AI." },
  ...
  { id: "LD1.96", title: "Annie Duke — AI vs Humans on Probability Words", component: AnnieDukeStudyScreen, duration: 5, notes: "Same words, different meanings. Humans range 30-80% on 'serious possibility'; ChatGPT says 70%, Gemini says 50%. Even AI models disagree with each other." },
