...
export const screens: ScreenDef[] = [
  ...
  { id: "LD3.62", title: "Annie Duke — Same Words, Different Meanings (Humans Only)", component: AnnieDukeStudyScreen, duration: 5, notes: "Humans-only view of the Sherman Kent / Annie Duke study. ChatGPT/Gemini reveal happens later at LD1.96.", props: { hideAI: true } },
