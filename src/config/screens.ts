...
export const screens: ScreenDef[] = [
  ...
  { id: "LD0.05", title: "First Principles: Windshield Wipers", component: WindshieldWipersScreen, duration: 5, notes: "Does a self-driving car need windshield wipers? Interactive poll revealing first-principles thinking.", hasPoll: true, pollQuestion: "Does a self-driving car need windshield wipers?", pollOptions: ["Yes", "No", "Who knows anymore?"] },
  ...
  { id: "LD5.0", title: "Pattern Recognition & Perspective", component: PatternRecognitionScreen, duration: 6, notes: "Autistic detail focus vs neurotypical gestalt processing.", hasPoll: true, pollQuestion: "What did you see first?", pollOptions: ["Duck (facing right)", "Rabbit (facing left)", "Both at the same time", "Neither/Unsure"] },
  ...
  { id: "LD1.0", title: "The Curb-Cut Effect: Introduction", component: CurbCutIntroScreen, duration: 180, notes: "Curb-cut effect intro." },
  { id: "LD1.0-Quiz-1", title: "Quiz Q1: Closed Captions", component: CurbCutQuizScreen, duration: 60, notes: "Q1.", hasPoll: true, pollQuestion: "What percentage of ALL viewers use closed captions (not just deaf/hard-of-hearing)?", pollOptions: ["20%", "45%", "71%", "85%"] },
  { id: "LD1.0-Quiz-2", title: "Quiz Q2: Chunked Content", component: CurbCutQuizScreen, duration: 60, notes: "Q2.", hasPoll: true, pollQuestion: "How much does chunked content improve completion rates for everyone?", pollOptions: ["10%", "30%", "50%", "75%"] },
  { id: "LD1.0-Quiz-3", title: "Quiz Q3: Multiple Formats", component: CurbCutQuizScreen, duration: 60, notes: "Q3.", hasPoll: true, pollQuestion: "What percentage of learners prefer multiple format options (text + audio + visual)?", pollOptions: ["40%", "60%", "80%+", "95%"] },
  { id: "LD1.0-Results", title: "The Curb-Cut Effect: Results", component: CurbCutResultsScreen, duration: 300, notes: "Reveal stats.", pollOptions: ["Yes - often", "Yes - occasionally", "Not that I know of", "Not sure"] },
